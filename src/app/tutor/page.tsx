...
export default async function TutorDashboard() {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-300 font-futura">
                      ...
                      >
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex items-center space-x-2 text-sm">
                            ...
                            <span className={`font-medium ${urgency === 'urgent' ? 'text-red-600 dark:text-red-400' :
